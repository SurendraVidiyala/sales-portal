...
<h4>Client Information - Indian Arts & Culture</h4>
	...
	<div class="col-md-6">
								<div class="form-group">
									<div class="col-lg-2">
									<label for="inputEmail1" class="control-label pull-right">Project Name</label>
									</div>
									<div class="col-lg-10">
										<input class="form-control" id="inputEmail1" name="pname" type="text">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-2">
									<label for="inputEmail1" class="control-label pull-right">Project Manager</label>
									</div>
									<div class="col-lg-10">
										<input class="form-control" id="pmanager" name="pmanager" type="text">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-2">
									...
									<div class="col-lg-10">
										<input class="form-control" id="dateadded" name="dateadded"  type="text">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-2">
									<label for="inputEmail1" class="control-label pull-right">Project Amount</label>
									</div>
									<div class="col-lg-10">
										<input class="form-control" id="pamount" name="pamount" type="text">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-2">
								...
								<div class="form-group">
									<div class="col-lg-2">
									<label for="inputEmail1" class="control-label pull-right">Project Status</label>
									</div>
									<div class="col-lg-10">
										<input class="form-control" id="pstatus" name="pstatus" type="text">
										<select name="pstatus">
								...
								<div class="form-group">
									<div class="col-lg-2">
									<label for="inputEmail1" class="control-label pull-right">Launch Date</label>
									</div>
									<div class="col-lg-10">
										<input class="form-control" id="ldate"  name="ldate" type="text">
									</div>
	...
	<div class="form-group">
									...
									<div class="col-lg-10">
										<input class="form-control" id="ctel" n="ctel" type="text">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<label for="inputEmail1" class="control-label ">Project Description</label>
									</div>
									<div class="col-lg-offset-1 col-lg-11 text-center" id="pdesc" name="pdesc">
										<textarea cols="100" rows="9"></textarea>
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-2">
									<label for="inputEmail1" class="control-label pull-right">Project Notes</label>
									</div>
									<div class="col-lg-10">
										<input class="form-control" id="pnotes" name="pnotes" type="text">
									</div>
								</div>
	</div>
	</div>
