...
<html lang="en">
  ...
  <body>
  <form action="OpportunitiesController" method="post">
...
<h4>Client Information - Indian Arts & Culture</h4>
	...
	<div class="col-md-6">
								<div class="form-group">
									<div class="col-lg-2">
									<label for="inputEmail1" class="control-label pull-right">Opportunities Name</label>
									</div>
									<div class="col-lg-10">
										<input class="form-control" id="oname" name="oname" type="cname">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-2">
									<label for="inputEmail1" class="control-label pull-right">Added by</label>
									</div>
									<div class="col-lg-10">
										<input class="form-control" id="addedby" name="addedby" type="text">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-2">
									...
									<div class="col-lg-10">
										<input class="form-control" id="addDate" name="addDate"  type="text">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-2">
								...
								<div class="form-group">
									<div class="col-lg-2">
									<label for="inputEmail1" class="control-label pull-right">Opportunity Duration</label>
									</div>
									<div class="col-lg-10">
								...
								<div class="form-group">
									<div class="col-lg-2">
									<label for="inputEmail1" class="control-label pull-right">Opportunity Type</label>
									</div>
									<div class="col-lg-10">
	...
	<div class="form-group">
								...
								<div class="form-group">
									...
									<label for="inputEmail1" class="control-label ">Opportunity Description</label>
									</div>
									<div class="col-lg-offset-1 col-lg-11 text-center" id="odesc" name="odesc">
										<textarea cols="100" rows="9"></textarea>
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-2">
									<label for="inputEmail1" class="control-label pull-right">Opportunity Notes</label>
									</div>
									<div class="col-lg-10">
										<input class="form-control" id="onotes" name="onotes" type="text">
									</div>
								</div>
