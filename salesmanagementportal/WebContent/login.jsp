...
<html lang="en">
  ...
  <div class="wizardCont">
	...
	<h2><strong> <a href="index.html">Home</a></strong></h2>
	<center>
    ...
    <button type="submit">Login</button><button type="reset">Reset</button><br><br>
    
   <a href="clientlogin.jsp">Click here for User Login</a>
